...
THEFT_PUBLIC
enum theft_run_res theft_run(const struct theft_run_config* cfg);

/* Generate the instance based on a given seed, print it to F,
 * and then free it. (If print or free callbacks are NULL,
 * they will be skipped.) */
THEFT_PUBLIC
enum theft_generate_res theft_generate(FILE* f, theft_seed seed,
...
THEFT_PUBLIC
enum theft_hook_trial_post_res theft_hook_trial_post_print_result(
