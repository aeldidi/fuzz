...
struct autoshrink_env* theft_autoshrink_alloc_env(struct theft* t,
		uint8_t arg_i, const struct theft_type_info* type_info);
...
enum theft_autoshrink_wrap theft_autoshrink_wrap(struct theft* t,
		struct theft_type_info*                        type_info,
		struct theft_type_info*                        wrapper);

void theft_autoshrink_free_bit_pool(
		struct theft* t, struct autoshrink_bit_pool* pool);

void theft_autoshrink_bit_pool_random(struct theft* t,
...
void theft_autoshrink_print(struct theft* t, FILE* f,
		struct autoshrink_env* env, const void* instance,
		void* type_env);

enum theft_shrink_res theft_autoshrink_shrink(struct theft* t,
		struct autoshrink_env* env, uint32_t tactic, void** output,
...
void theft_autoshrink_model_set_next(
